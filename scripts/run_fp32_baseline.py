...
if __name__ == '__main__':
    ...
    video_depth_anything.load_state_dict(torch.load(f'{VDA_PATH}/checkpoints/{checkpoint_name}_{args.encoder}.pth', map_location='cpu'), strict=True)
